...
mongo_uri = 'mongodb+srv://qaninja:academy@cluster0.nlzkf.mongodb.net/TrelloClone?retryWrites=true&w=majority'
...
def get_hash_pass(password):
    return bcrypt.hashpw(password.encode('utf8'), bcrypt.gensalt(8))
